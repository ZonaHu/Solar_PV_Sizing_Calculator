    ...
    return <div>
        ...
        <Card style={{width: '90%', margin: '50px', textAlign: 'left'}}>
            ...
            <div style={{display: 'flex', alignItems: 'center', marginTop: '20px', marginBottom: '20px'}}>
                ...
                <InputNumber style={{marginLeft: '20px', width: '100px'}} min={500} max={5000} step={10} value={spPrice}
                             onChange={handleSolarPanelPriceChange}/>
            </div>
            ...
            <table className="my-table">
                ...
                <tr>
                    ...
                    <td>$535.72</td>
                    <td>
                        <button className="my-button" onClick={() => setBatteryPrice(535.72)}>Use this price</button>
                    </td>
                </tr>
                <tr>
                    <td>Sonnen eco</td>
                    ...
                    <td>$2487.5</td>
                    <td>
                        <button className="my-button" onClick={() => setBatteryPrice(2487.5)}>Use this price</button>
                    </td>
                </tr>
                </tbody>
            </table>
            <div style={{display: 'flex', alignItems: 'center', marginTop: '20px'}}>
                ...
                <InputNumber style={{marginLeft: '20px', width: '100px'}} min={100} max={2500} step={10}
                             value={batteryPrice} onChange={handleBatteryPriceChange}/>
            </div>
        </Card>
        <Card style={{width: '90%', margin: '50px', textAlign: 'left'}}>
            ...
            <Paragraph>
                Leaving this to the default values is fine. The calculator will return the optimal, feasible system that
                exists within the capacity value. Higher capacity may result in less precise answers, whereas capacity
                is more likely to generate infeasible results.
            </Paragraph>
            <div style={{display: 'flex', alignItems: 'center', marginTop: '20px'}}>
                <span style={{marginRight: '20px'}}>Solar Panel Capacity:</span>
                <InputNumber style={{width: '100px'}} min={1} defaultValue={10}/>
            </div>
            <div style={{display: 'flex', alignItems: 'center', marginTop: '20px'}}>
        ...
        <Card style={{width: '90%', margin: '50px', textAlign: 'left'}}>
            ...
            <div style={{display: 'flex', alignItems: 'center'}}>
                ...
                <InputNumber style={{width: '75px'}} min={0.5} max={1} step={0.01} defaultValue={0.8}/>
            </div>

            <div style={{display: 'flex', alignItems: 'center', marginTop: '20px'}}>
                <span style={{marginRight: '20px'}}>Days In Sample:</span>
                <InputNumber style={{width: '75px'}} min={1} max={365} defaultValue={100}/>
            </div>
        </Card>
    </div>
}