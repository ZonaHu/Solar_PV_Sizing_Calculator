...
export const SolarPanelParameters = forwardRef((props, ref) => {
  ...
  return <div>
    ...
    <Form name="step2" form={form}>
      ...
      <Card style={{ width: '90%', margin: '50px', textAlign: 'left' }}>
        ...
        <Paragraph>
          <b>System Losses (%)*</b>
          <Form.Item noStyle name="losses" rules={[{required: true}]}>
            <InputNumber
...
SolarPanelParameters.displayName = 'SolarPanelParameters';